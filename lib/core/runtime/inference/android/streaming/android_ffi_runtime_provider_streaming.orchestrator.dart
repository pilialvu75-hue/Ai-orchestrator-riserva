...
extension _AndroidFfiRuntimeStreamingExtension on AndroidFfiRuntimeProvider {
          ...
          await _concurrencyManager.runInferenceSerially(() async {
            ...
            try {
              ...
              await _executeStreamingPollingLoop(
                ...
                classifyFirstTokenTermination: classifyFirstTokenTermination,
                pollIterations: pollIterations,
                firstTokenAt: firstTokenAt,
                estimatedTokens: estimatedTokens,
                runtimeNeedsReset: runtimeNeedsReset,
                runtimeResetReason: runtimeResetReason,
              );
