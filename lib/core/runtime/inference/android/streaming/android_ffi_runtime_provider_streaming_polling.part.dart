...
extension AndroidFfiRuntimeStreamingPollingExtension on AndroidFfiRuntimeProvider {
  Future<void> _runTokenPollingLoop({
    ...
    required Pointer<Utf8> promptNativePtr,
    required void Function() freePromptNativePtr,
