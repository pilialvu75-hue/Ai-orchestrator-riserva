        ...
        if (status == 1) {
          ...
          try {
            ...
            if (state.consecutiveInvalidTokens >= AndroidFfiRuntimeProvider._maxConsecutiveInvalidTokens) {
              ...
              AndroidFfiRuntimeProvider._finishWithRuntimeError( controller, stage: 'token_decode', message: 'Invalid generated token stream.', details: error.toString(), );
              break;
            }
            continue;
          }
          ...
          if (sanitizedPiece == state.lastPiece) {
            ...
            if (state.repeatedTokenCount >= AndroidFfiRuntimeProvider._maxRepeatedTokenLoop) {
              ...
              AndroidFfiRuntimeProvider._finishWithRuntimeError( controller, stage: 'generation_loop', message: 'Repeated-token loop detected.', details: 'token="$sanitizedPiece"', );
              break;
            }
          } else {
