...
class LocalPromptTemplates {
  ...
  static String compose({
    ...
    // IMPORTANTE:
    //
    // Non iniettiamo più globalmente istruzioni <search> nel prompt locale.
    //
    // La ricerca web viene già gestita dall'Orchestrator tramite
    // IntentAnalyzer -> TaskType.webSearch -> WebSearchTool.
    //
    // Inserire l'istruzione <search> in OGNI prompt locale provocava
    // comportamenti indesiderati soprattutto sui modelli piccoli:
    //
    //   ciao
    //   -> il modello vede l'istruzione di ricerca
    //   -> può produrre <search>...
    //   -> InferenceService intercetta il tag
    //   -> annulla la generazione
    //   -> esegue una ricerca
    //   -> ricostruisce il prompt
    //   -> il modello può produrre nuovamente <search>...
    //
    // Le richieste web esplicite vengono già intercettate prima
    ...
    //
    // Manteniamo esclusivamente i turni validi e non esclusi.
    // L'ordine cronologico viene preservato.
