...
void main() {
  group('WorkshopInferenceServiceFactory', () {
    ...
    test('Workshop inference does not require Assistant runtime settings', () async {
      ...
      // Deliberately do not register AiRuntimeSettingsService. Cantiere must
      // not read the Assistant's persisted Local/Cloud/Hybrid preference.
